...
public class MyLocationListenerWithPois implements LocationListener {
	private final OpenSeamapViewerWithPois openseamapviewer;
	private boolean centerAtFirstFix;

	public MyLocationListenerWithPois(OpenSeamapViewerWithPois advancedMapViewer) {
