...
public class SplitSeamarksWithAerialOverlay extends Overlay {
    ...
    private float pDisplayFactor = 1.0f;
	/**
	 ...
	 */
    public SplitSeamarksWithAerialOverlay(Drawable defaultMarker, SplitOpenSeaMapWithAerialOverlayViewer context,SeamarkOsm seamarkOsm , boolean fillDirectionalSector, float mDisplayFactor ) {
		super();
